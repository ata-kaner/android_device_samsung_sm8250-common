...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/nfc/libnfc-nci-NXP_SN100U.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/libnfc-nci-NXP_SN100U.conf \
    $(COMMON_PATH)/configs/nfc/libnfc-nci-SLSI.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/libnfc-nci-SLSI.conf
