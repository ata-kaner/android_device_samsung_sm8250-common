...
void vendor_load_properties()
{
    ...
    if (bootloader.find("G780G") == 0) {
         ...
         property_override("ro.build.fingerprint", "samsung/r8qxx/r8q:11/RP1A.200720.012/G780GXXS8EXC1:user/release-keys");
    }
         ...
         property_override("ro.build.fingerprint", "samsung/r8qxxx/r8q:11/RP1A.200720.012/G781BXXS9HXC2:user/release-keys");
    }
